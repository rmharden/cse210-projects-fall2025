...
// Returning the index of the _prompts, or "return _prompts[i] came from our lesson about iterating through a List. This same area in our less also has examples of using Count with the instance of the list.